...
export default function EditOfferForm({session, record, onEdit, onClose}) {
    ...
    return (
        <Form className="form" onSubmit={handleSubmit}>
          <ModalHeader toggle={onClose}>Editar Oferta</ModalHeader>
          <ModalBody>
          <Nav tabs>
            <NavItem>
              <NavLink
          ...
          <TabContent activeTab={activeTab}>
            ...
            <TabPane tabId="2">
                <ProductForm session={session} setProducts={setProducts} offer_id={offer.id} />
            </TabPane>
          </TabContent>
        </ModalBody>
        <ModalFooter>
